...
, CUSTOM_OBJECT_TABLE VARCHAR2(1) DEFAULT 'N' NOT NULL
...
Rem CREATE TABLE ADF_EXTENSIBLE_TABLE 
Rem (
Rem   TABLE_NAME VARCHAR2(30) NOT NULL 
Rem , APPLICATION_ID VARCHAR2(30) NOT NULL
Rem , CONTEXT_COLUMN_NAME VARCHAR2(30) 
Rem , TABLE_ID NUMBER(18) NOT NULL
Rem , PARENT_ENTITYDEF_FULLNAME VARCHAR2(240)
Rem , CUSTOM_OBJECT_TABLE VARCHAR2(1) DEFAULT 'N' NOT NULL
Rem , PARENT_ID_COLUMN_NAME VARCHAR2(30)
Rem , LAST_ALLOCATION TIMESTAMP
Rem , CAPACITY NUMBER(1) DEFAULT 0 NOT NULL
Rem   CONSTRAINT ADF_EXTN_TBL_CAPACITY CHECK
Rem   (
Rem     CAPACITY IN (0, 1, 2, 3)
Rem   )
Rem   ENABLE 
Rem , CONSTRAINT ADF_EXTENSIBLE_TABLE_PK PRIMARY KEY 
Rem   (
Rem     TABLE_ID 
Rem   )
Rem   ENABLE 
