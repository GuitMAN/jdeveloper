...
optional = frozenset(['-srcApp', '-dstApp', '-srcFolder', '-dstFolder', '-dstLdifFile', '-srcConfigFile', '-processPrivRole', '-resourceTypeFile', '-overWrite', '-migrateIdStoreMapping', '-dropUsers', '-preserveAppRoleGuid', '-reportFile', '-mode', '-metaData'])
import jpsCmdHelp
