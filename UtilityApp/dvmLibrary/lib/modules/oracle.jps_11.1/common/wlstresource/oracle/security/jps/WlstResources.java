/* $Header: jazn/jps/jrf/common/wlstresource/oracle/security/jps/WlstResources.java /st_entsec_11.1.1.9.0/4 2014/08/19 07:12:32 miqi Exp $ */
...
/*
   ...
   MODIFIED    (MM/DD/YY)
    miqi        08/13/14 - add message for cleanSecurityStore
    braghuna    12/27/13 - interop related code changes.
    pichan      09/30/13 - bug 17404137: restrict only one security store per
                           db schema
    sourajai    08/01/13 - XbranchMerge dozhou_mt_txns from st_entsec_pt-opssmt
...
/**
 *  @version $Header: jazn/jps/jrf/common/wlstresource/oracle/security/jps/WlstResources.java /st_entsec_11.1.1.9.0/4 2014/08/19 07:12:32 miqi Exp $
 *  @author  vigarg  
...
public class WlstResources extends ListResourceBundle implements WlstMessages {
    ...
    { 
        ...
        {MSG_WLST_SYNC_KS_DONE, "Keystore sync successful."},
        ...
        {MSG_WLST_DB_SECURITY_STORE_EXISTS, "The specified database schema is already in use for security store.  Please create a new schema."},
        {MSG_WLST_MIGRATECHECK_DONE, "Executing compatibility checks on the security store."},
        {MSG_WLST_SKIP_DONE, "Incompatible artifacts may be selectively skipped during migration."},
        {MSG_WLST_MIGRATE_NOTVALID, "migrate option is not valid in this context as join is false."},
        {MSG_WLST_SKIP_NOTVALID, "skip option is not valid in this context as join is false."},
        {MSG_WLST_FORCE_NOTVALID, "force option is not valid in this context as join is true."},
        {MSG_WLST_CLEAN_SECURITYSTORE_START, "Start cleaning security store DIT."},
        {MSG_WLST_CLEAN_SECURITYSTORE_END, "Security store DIT has been cleaned."}
