...
######################################################
def grantEntitlement(appStripe=None, principalName=None, principalClass=None, entitlementName=None, identityDomain=None) :
    m = HashMap()
    m.put("appStripe",appStripe)
    m.put("principalName",principalName)
    m.put("principalClass",principalClass)
    m.put("entitlementName",entitlementName)
    m.put("identityDomain", identityDomain)
    on = getCompleteMBeanName(JpsJmxConstants.MBEAN_JPS_APPLICATION_POLICY_STORE)
...
######################################################
def revokeEntitlement(appStripe=None, principalName=None, principalClass=None, entitlementName=None, identityDomain=None) :
    m = HashMap()
    m.put("appStripe",appStripe)
    m.put("principalName",principalName)
    m.put("principalClass",principalClass)
...
def grantAppRole(appStripe=None, appRoleName=None, principalClass=None, principalName=None, forceValidate="true") : 
    ...
    m.put("principalClass", principalClass)
    m.put("principalName", principalName)
    m.put("forceValidate", forceValidate)
    on = getCompleteMBeanName(JpsJmxConstants.MBEAN_JPS_APPLICATION_POLICY_STORE)
    try :
...
def migrateSecurityStore(type=None, src=None, dst=None, srcApp=None, dstApp=None, srcFolder=None, dstFolder=None, dstLdifFile=None, srcConfigFile=None, configFile=None, overWrite=None, processPrivRole=None, resourceTypeFile=None, migrateIdStoreMapping=None, preserveAppRoleGuid=None, mode=None, reportFile=None) :   
    migrateSecurityStore(type, src, dst, srcApp, dstApp, srcFolder, dstFolder, dstLdifFile, srcConfigFile, configFile, overWrite, processPrivRole, resourceTypeFile, migrateIdStoreMapping, preserveAppRoleGuid, mode, reportFile, "false")

def migrateSecurityStore(type=None, src=None, dst=None, srcApp=None, dstApp=None, srcFolder=None, dstFolder=None, dstLdifFile=None, srcConfigFile=None, configFile=None, overWrite=None, processPrivRole=None, resourceTypeFile=None, migrateIdStoreMapping=None, preserveAppRoleGuid=None, mode=None, reportFile=None, opss_wlst_or_wsadmin_migration=None) :
    m = HashMap()
    m.put("type", type)
    m.put("src", src)
    m.put("dst", dst)
    ...
    m.put("opss_wlst_or_wsadmin_migration", opss_wlst_or_wsadmin_migration)
    try :
...
def patchPolicyStore(phase=None, patchDeltaFolder=None, productionJpsConfig=None, baselineFile=None, patchFile=None, baselineAppStripe=None, productionAppStripe=None, patchAppStripe=None, silent=None, ignoreEnterpriseMembersOfAppRole=None, reportFile=None, ignoreEnterpriseAppRoleMembershipConflicts=None) :
    ...
    m.put("opss_wlst_or_wsadmin_migration","true")
    try :
...
def upgradeOpss(jpsConfig=None, jaznData=None, auditStore=None, jdbcDriver=None, url=None, user=None, password=None, upgradeJseStoreType=None, transformData=None):
    ...
    m.put("transformData", transformData)
    try :
