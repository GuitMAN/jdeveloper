Rem
Rem $Header: entsec_ldap/java/src/oracle/security/audit/rcu/scripts/ReportsServerComponent.sql /st_entsec_11.1.1.9.0/1 2014/03/05 08:49:33 rkoul Exp $
Rem
...
ON ReportsServerComponent(IAU_ID);
